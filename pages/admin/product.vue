  ...
  >
    <v-row>
      <v-col class="d-flex justify-center align-center">
        <h1 style="color: rgb(248, 244, 244)">Cadastro de Produtos</h1>
      </v-col>
    </v-row>
        ...
        <v-card-content style="padding: 15px">
          ...
          <v-row>
            <v-col class="d-flex justify-center">
              <!-- <v-img max-width="400px" src="https://di2ponv0v5otw.cloudfront.net/posts/2022/07/28/62e34fc232c1dc776cca46dd/m_62e34ffb678c3ada21436aa1.jpg"/> -->
            </v-col>
          </v-row>
        </v-card-content>
        <v-card-actions>
